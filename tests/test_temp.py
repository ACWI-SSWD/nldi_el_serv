...
# help_result3 = runner.invoke(cli.main, ['xsatpoint', '-f', 'test1.json', '--lonlat', '-103.80119', '40.2684', '--width', '1000', '--numpoints', '101'])
help_result3 = runner.invoke(cli.main, ['xsatpoint', '--lonlat', '-103.80119', '40.2684', '--width', '1000', '--numpoints', '101'])
